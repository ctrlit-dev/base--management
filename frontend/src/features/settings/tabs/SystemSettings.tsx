...
import { SettingsSection, SystemStatus } from '@/features/settings/settings/SettingsComponents';
...
function SystemSettingsTab({ onSave, onFieldChange }: SystemSettingsProps) {
  ...
  const sections = SETTINGS_SECTIONS.system || [];
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-text-secondary">Lade System-Einstellungen...</span>
      </div>
    );
  }
