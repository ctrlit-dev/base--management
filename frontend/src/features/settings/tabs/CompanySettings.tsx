...
function CompanySettings({ onSave, onFieldChange }: CompanySettingsProps) {
  ...
  const sections = SETTINGS_SECTIONS.company || [];
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-text-secondary">Lade Firmen-Einstellungen...</span>
      </div>
    );
  }
