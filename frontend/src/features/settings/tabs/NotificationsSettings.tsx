...
function NotificationsSettings({ onSave, onFieldChange }: NotificationsSettingsProps) {
  ...
  const sections = SETTINGS_SECTIONS.notifications || [];
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-text-secondary">Lade Benachrichtigungs-Einstellungen...</span>
      </div>
    );
  }
