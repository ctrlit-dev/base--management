...
function BackupSettings({ onSave, onFieldChange }: BackupSettingsProps) {
  ...
  const sections = SETTINGS_SECTIONS.backup || [];
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-text-secondary">Lade Backup-Einstellungen...</span>
      </div>
    );
  }
