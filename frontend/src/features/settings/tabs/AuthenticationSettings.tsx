...
function AuthenticationSettings({ onSave, onFieldChange }: AuthenticationSettingsProps) {
  ...
  const sections = SETTINGS_SECTIONS.authentication || [];
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-text-secondary">Lade Authentifizierungs-Einstellungen...</span>
      </div>
    );
  }
