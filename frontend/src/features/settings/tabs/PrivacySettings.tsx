...
function PrivacySettings({ onSave, onFieldChange }: PrivacySettingsProps) {
  ...
  const sections = SETTINGS_SECTIONS.privacy || [];
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-text-secondary">Lade Datenschutz-Einstellungen...</span>
      </div>
    );
  }
