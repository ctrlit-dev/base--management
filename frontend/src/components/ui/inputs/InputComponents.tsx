 ...
 * ========================
 * 
 * Zentrale Input-Komponenten für konsistente Formulare.
 * Eliminiert wiederholte Input-Styles.
 */
...
export const EmailInput = forwardRef<HTMLInputElement, BaseInputProps>(
  (props, ref) => <BaseInput ref={ref} type="email" {...props} />
);

export const PasswordInput = forwardRef<HTMLInputElement, BaseInputProps & { showPassword?: boolean; onTogglePassword?: () => void }>(
...
export const InputRow: React.FC<InputRowProps> = ({ children, className = '' }) => (
