                      ...
                      <div className="mt-3 p-4 bg-gradient-to-r from-orange-500/3 to-red-500/3 border border-orange-500/10 rounded-lg">
                        <div className="grid grid-cols-1 gap-2">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                          >
                            <div className="font-medium">Test User (ADMIN)</div>
                            <div className="text-blue-500/70">test@example.com</div>
                          </motion.button>
                          ...
                          >
                            ...
                            <div className="text-purple-500/70">admin@lcree.com</div>
                          </motion.button>
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                          >
                            <div className="font-medium">Produktion (PRODUCTION)</div>
                            <div className="text-green-500/70">production@lcree.com</div>
                          </motion.button>
                          ...
                          <motion.button
                            ...
                            className="w-full p-2 text-xs rounded-md bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 border border-yellow-500/30 hover:border-yellow-500/50 hover:bg-gradient-to-r hover:from-yellow-500/15 hover:to-yellow-600/15 transition-all duration-300 text-yellow-600 hover:text-yellow-700"
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                          >
                            <div className="font-medium">Lager (WAREHOUSE)</div>
                            <div className="text-yellow-500/70">warehouse@lcree.com</div>
                          </motion.button>
                          ...
                          <motion.button
                            ...
                            className="w-full p-2 text-xs rounded-md bg-gradient-to-r from-indigo-500/10 to-indigo-600/10 border border-indigo-500/30 hover:border-indigo-500/50 hover:bg-gradient-to-r hover:from-indigo-500/15 hover:to-indigo-600/15 transition-all duration-300 text-indigo-600 hover:text-indigo-700"
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                          >
                            <div className="font-medium">Verkauf (SALES)</div>
                            <div className="text-indigo-500/70">sales@lcree.com</div>
                          </motion.button>
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                          >
                            <div className="font-medium">Betrachter (VIEWER)</div>
                            <div className="text-gray-500/70">viewer@lcree.com</div>
                          </motion.button>
                        </div>
                      </div>
                    </motion.div>
